...
|Only type if user has clicked on the box| If the users last click was on the text box and the user presses a key, enter text otherwise dont| As stated in "whats supposed to happen"| Textbox is complete|